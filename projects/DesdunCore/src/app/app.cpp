...
namespace DesdunCore
{
	...
	void Application::init()
	{
        ...
        // todo: reconsider whether the vm should be stored in app or not
        // the same needs to be done with FontFace and Resource
        // statics are probably not the way to go. maybe services or something instead?
        // like ScriptService and ResourceService and stuff
        ...
        dd_define_enum(Input::KeyCode, "KeyCode",
        {
        ...
        state.new_enum<Input::MouseCode>("MouseCode",
        {
